  ...
  return (
    <AuthCard title="Welcome back" description="Enter your phone or email to continue">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Link href="/parent/login" className="block w-full">
          <Button type="button" variant="secondary" size="lg" className="w-full gap-2">
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link href="/register-center" className="font-medium text-foreground hover:underline">
            Create one
          </Link>
        </p>
      </form>
