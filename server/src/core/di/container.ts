...
container.registerSingleton<IStudentsService>(TYPES.IStudentsService, UserService);
container.registerSingleton<IStudentsController>(TYPES.IStudentsController, UserController);
container.registerSingleton<IStudentsRepository>(TYPES.IStudentsRepository, StudentsRepository);

container.registerSingleton<IBatchesService>(TYPES.IBatchesService, UserService);
container.registerSingleton<IBatchesController>(TYPES.IBatchesController, UserController);
...
container.registerSingleton<ITeacherPaymentsService>(TYPES.ITeacherPaymentsService, TeacherService);
container.registerSingleton<ITeacherPaymentsController>(TYPES.ITeacherPaymentsController, TeacherController);
container.registerSingleton<ITeacherPaymentsRepository>(TYPES.ITeacherPaymentsRepository, TeacherPaymentsRepository);

container.registerSingleton<ITeacherAttendanceService>(TYPES.ITeacherAttendanceService, TeacherService);
container.registerSingleton<ITeacherAttendanceController>(TYPES.ITeacherAttendanceController, TeacherController);
...
container.registerSingleton(ParentService, ParentService);
container.registerSingleton(NotificationOrchestratorService, NotificationOrchestratorService);
container.registerSingleton(ParentController, ParentController);
